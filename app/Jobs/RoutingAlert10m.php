...
class RoutingAlert10m extends Job
{
    ...
    public function handle(){
        ...
        $route_sp_ids = DB::select("SELECT DISTINCT `subscription_id`, `id`,`sub_category_id`,`routing_before`,`status`,`no_of_route` FROM routing.sp_routing_alerts where routing_before = '10' and no_of_route = '1' and (status ='SEARCHING' or status ='ACCEPTED')");
